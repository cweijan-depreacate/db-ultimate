...
public class Operation{
   ...
   */
  public Operation(boolean autoConvert){
  ...
  public void join(String table, String alias, String onOperation){

    if(joinTables == null) joinTables = new ArrayList<>();

    String segment = "join " + table + " " + alias + " on " + onOperation;
    joinTables.add(segment);
  }

  private List<String> getOperationList(Map<String, List<String>> map, String key){
  ...
  public void put(Map<String, List<String>> map, String column, Object value){
    ...
    column = convert(column);
    List<String> operationList = getOperationList(map, column);
    operationList.add(value.toString());
    map.put(column, operationList);
  }
  ...
  public Map<String, List<String>> getNotEqualsOperation(){
  ...
  public Map<String, List<String>> getEqualsOperation(){

    return equalsMap;
  }

  public Map<String, List<String>> getOrEqualsOperation(){
  ...
  public Map<String, List<String>> getSearchOperation(){
